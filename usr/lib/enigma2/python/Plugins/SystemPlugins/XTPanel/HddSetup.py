...
def DiskEntry(model, size, removable):
    ...
    if removable:
        picture = '/usr/lib/enigma2/python/Plugins/SystemPlugins/XTPanel/pictures/diskusb.png'
    else:
        picture = '/usr/lib/enigma2/python/Plugins/SystemPlugins/XTPanel/pictures/disk.png'
